...
// Copyright (c) 2014-2018 The Book Core developers
...
{
    const char* pszTimestamp = "books equal knowledge, read more books";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2 * 60; // Book: every blocks
        consensus.nPowTargetSpacing = 2 * 60; // Book: 2 minutes
        ...
        genesis = CreateGenesisBlock(1534347174, 1219368, 0x1e0ffff0, 1, 25 * COIN);
   ...
   /*
	 //////////////
       ...
       */ 
        assert(consensus.hashGenesisBlock == uint256S("00000de4422dffd8715158f61cff4e41d145c3a06174f0778a53d1a0eff0ff5c"));
        assert(genesis.hashMerkleRoot == uint256S("3baa7b546b9e71d63e68995f3b2263b7a0556cdff4f8eaa83ef0911820dd0d8b"));
        vSeeds.push_back(CDNSSeedData("bookseeds2", "dnsseed.book.be"));
        vSeeds.push_back(CDNSSeedData("bookseeds1", "dnsseed.book.be"));
        // Book addresses start with 'B'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        // Book script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Book private keys start with 'E'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,33);
        // Book BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Book BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Book BIP44 coin type is '5'
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("00000de4422dffd8715158f61cff4e41d145c3a06174f0778a53d1a0eff0ff5c")),
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 60 * 60; // Book: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // Book: 2 minutes
   ...
   //     assert(genesis.hashMerkleRoot == uint256S("0x33a98e8f8089165dc24358b01d52dd740011bdbffad052d51d3ac3588af2f487"));
        ...
        // Testnet Book addresses start with 'R'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,61);
        // Testnet Book script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Testnet private keys start with '5' or 'n' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,33);
        // Testnet Book BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Book BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Book BIP44 coin type is '1' (All coin's testnet default)
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x00000de4422dffd8715158f61cff4e41d145c3a06174f0778a53d1a0eff0ff5c")),
...
public:
    CRegTestParams() {
        ...
        // Regtest Book addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,112);
        // Regtest Book script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Regtest private keys start with '5' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Regtest Book BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Book BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest Book BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
